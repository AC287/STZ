...
<div class="career-callout">
  <div class="container">
    <p class="career-blusm">STZ is a fun and exciting place to work.</p>
    ...
    <p class="career-blasm">If you are interested and qualified for any of the positions listed below, or if you think you can contribute to our company in another way, please email a cover letter and your resume to <a href="mailto:nmarquez@stzindustries.com">nmarquez@stzindustries.com</a></p>
    ...
    <?php
      ...
      if($career) {
        foreach($career as $careerinner) {
          ...
          echo "<a href='mailto:nmarquez@stzindustries.com?subject=CAREER - ".$careerinner->position."'>E-mail Us</a>";
          echo "</div>";
...
<div class="career-pagecallout">
  <div class="container">
    <div class="career-pagecallout-contents">
      ...
      <p class="career-blaxs">STZ is an equal opportunity employer with a wonderfully diverse workforce. We are proud of our diversity and encourage people from all walks of life to come play for our team.</p>
    </div>
  </div>
</div>
