...
function stz_script_enqueue() {
  ...
  wp_enqueue_style('customstyle',get_template_directory_uri().'/css/stz.css', array(), '1.0.01', 'all');
  ...
  wp_enqueue_script('customjs',get_template_directory_uri().'/js/stz.js', array('jquery'), '1.0.01', true);
