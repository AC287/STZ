<?php
  /*
    NOTES:
      ...
      Then update stzmetadesc spreadsheet.
  */
  ...
  switch (true) {
    ...
    case (empty($curLocationArr)):
      ...
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='home';");
    ...
    case (in_array('products',$curLocationArr) || in_array('search',$curLocationArr)):
      ...
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='products';");
      switch ($curLocationArr) {
    ...
    case (in_array('about', $curLocationArr)):
      ...
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='about';");
      echo "<title>STZ | ".$metatitleDB[0]->title."</title>";
      echo "<meta name='description' content='".htmlspecialchars($metatitleDB[0]->metadesc,ENT_QUOTES)."'>";
    break;
    ...
    case (in_array('industries', $curLocationArr)):
      //GET ABOUT TITLE AND META DESC TAG.
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='industries';");
      echo "<title>STZ | ".$metatitleDB[0]->title."</title>";
      echo "<meta name='description' content='".htmlspecialchars($metatitleDB[0]->metadesc,ENT_QUOTES)."'>";
    break;
    ...
    case (in_array('team', $curLocationArr)):
      ...
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='team';");
      echo "<title>STZ | ".$metatitleDB[0]->title."</title>";
      echo "<meta name='description' content='".htmlspecialchars($metatitleDB[0]->metadesc,ENT_QUOTES)."'>";
    break;
    ...
    case (in_array('brands', $curLocationArr)):
      //GET TEAM TITLE AND META DESC TAG.
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='brands';");
      echo "<title>STZ | ".$metatitleDB[0]->title."</title>";
      echo "<meta name='description' content='".htmlspecialchars($metatitleDB[0]->metadesc,ENT_QUOTES)."'>";
    break;
    ...
    case (in_array('career', $curLocationArr)):
      //GET TEAM TITLE AND META DESC TAG.
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='career';");
      echo "<title>STZ | ".$metatitleDB[0]->title."</title>";
      echo "<meta name='description' content='".htmlspecialchars($metatitleDB[0]->metadesc,ENT_QUOTES)."'>";
    break;
    ...
    case (in_array('contact', $curLocationArr)):
      //GET TEAM TITLE AND META DESC TAG.
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='contact';");
      echo "<title>STZ | ".$metatitleDB[0]->title."</title>";
      echo "<meta name='description' content='".htmlspecialchars($metatitleDB[0]->metadesc,ENT_QUOTES)."'>";
    break;

    case (in_array('tradeshows', $curLocationArr)):
      $metatitleDB = $wpdb->get_results("SELECT * FROM wp_stzmetadesc WHERE page='tradeshows';");
      echo "<title>STZ | ".$metatitleDB[0]->title."</title>";
      echo "<meta name='description' content='".htmlspecialchars($metatitleDB[0]->metadesc,ENT_QUOTES)."'>";
    break;
